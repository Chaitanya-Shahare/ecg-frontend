...
const LandingPage: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Machine learning algorithms predict stroke risk with high accuracy",
    },
    {
      icon: TrendingUp,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <motion.div
              ...
              className="flex items-center justify-center space-x-8 mb-5"
            >
              <HeartAnimation />
            </motion.div>
            ...
            >
              Advanced ECG monitoring and AI-powered stroke prediction. Get
              personalized insights and take control of your cardiovascular
              wellness with cutting-edge technology.
            </motion.p>
